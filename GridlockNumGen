...
def RandomNumberGenerator_3000to40000(): #defining a function RandomNumberGenerator_3000to40000() for the task
    x=random.randrange(3000, 40001) # using randrange() to generate in range from 3000 to 40000, 40001 is used because last number is not included in the range elsewise
